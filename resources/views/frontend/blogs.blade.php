...
<section class="section blog-wrap">
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			...
			<div class="blog-item-content">
				...
				<h2 class="mt-3 mb-3"><a href="{{route('blog')}}">Choose quality service over cheap service  all type of things</a></h2>
				...
				<a href="{{route('blog')}}" target="_blank" class="btn btn-main btn-icon btn-round-full">Read More <i class="icofont-simple-right ml-2  "></i></a>
			</div>
		</div>
	</div>
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			<div class="blog-thumb">
				<img src="{{asset('frontend/images/blog/blog-2.jpg')}}" alt="" class="img-fluid">
			</div>

			<div class="blog-item-content">
				<div class="blog-item-meta mb-3 mt-4">
					<span class="text-muted text-capitalize mr-3"><i class="icofont-comment mr-2"></i>5 Comments</span/blog/n>
					<span class="text-black text-capitalize mr-3"><i class="icofont-calendar mr-1"></i> 28th January</span>
				</div> 

				<h2 class="mt-3 mb-3"><a href="{{route('blog')}}">All test cost 25% in always in our laboratory</a></h2>
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			<div class="blog-thumb">
				<img src="{{asset('frontend/images/blog/blog-4.jpg')}}" alt="" class="img-fluid">
			</div>
			...
			<div class="blog-item-content">
				...
				<h2 class="mt-3 mb-3"><a href="{{route('blog')}}">Get Free consulation from our special surgeon and doctors</a></h2>
